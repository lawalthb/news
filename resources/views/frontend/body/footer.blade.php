    ...
    <div class="footer-menu">
      <div class="menu-footer-menu-container">
        <ul id="menu-footer-menu" class="menu">
          ...
          <li id="menu-item-558" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-558"><a href=" ">OPINIONS</a></li>
        </ul>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-5 col-md-5">
          ...
          <div class="footer-content">
            <p style="text-align: left;">No 1 Street name, city, state</p>
            <p style="text-align: left;">EMAIL : support@eoaupdates.com</p>
            <p style="text-align: left;">MOBILE : 08131194469</p>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6">
              <h3 class="footer-title">
                EOA LOGO </h3>
              <div class="footer-content">
                <img src="{{asset('frontend/assets/images/logo_eoa.png')}}" width="200px" />
              </div>
            </div>
            <div class="col-lg-6 col-md-6">
              <h3 class="footer-title">
                AUTHOR</h3>
              <div class="footer-content">
                <p style="text-align: left;"> <img src="{{asset('upload/eoa-photo.png')}}" width="150px" height="150px" /><br />Name: Emmanuel O. Afolabi<br /> Occupation: Journalist</p>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6">
            <div class="copy-right">
              © All rights reserved :: EOA Updates </div>
          </div>
          <div class="col-lg-6 col-md-6">
            <div class="design-developed">
              Developed By <a href=" " target="_blank">lawalthb.com</a> </div>
          </div>
        </div>
      </div>
    </div>
    <a href="lawalthb.com" class="scrollToTop" style="margin-top:10px"><i class="las la-long-arrow-alt-up"></i></a>
  </div>
</footer>